...
import {
  ...
  topBrand,
  trendingSearch,
} from 'src/app/shared/models/home6.model';
...
export class HomeSixComponent implements OnInit {
  ...
  maxDate = new Date();
  public trendingsearch: trendingSearch[] = [];
  public choosecar: chooseCar[] = [];
  public Makecar: makeCar[] = [];
  public Topbrand: topBrand[] = [];
  public Rentcar: rentCar[] = [];
  public Teammembers: teamMembers[] = [];
  public clienttestimonials: clientTestimonials[] = [];
