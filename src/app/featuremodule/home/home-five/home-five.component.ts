...
import { businessSlider, customerSays, trendingPlace } from 'src/app/shared/models/home5.model';
...
export class HomeFiveComponent implements OnInit {
  ...
  public trendingplace: trendingPlace[] = [];
  public businessslider: businessSlider[] = [];
  public customersays: customerSays[] = [];
