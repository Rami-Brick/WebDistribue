...
import {
  ...
  venusList,
  weddingPackageData,
} from 'src/app/shared/models/home2.model';
...
export class Home2Component implements OnInit {
  ...
  public popular: popularList[] = [];
  public venus: venusList[] = [];
  public latestBlog: latestBlog[] = [];
  public bridesdata: bridesData[] = [];
  public weddingpackagedata: weddingPackageData[] = [];
  public lovedata: categories[] = [];
  public amazingwork: amazingWork[] = [];
