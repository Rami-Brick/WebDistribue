...
import { blogList, featuredAds, latestAdsList, pricingList, testimonialList, universitiesCompanies } from 'src/app/shared/models/home1.model';
...
export class Home1Component implements OnInit {
  ...
  public featuredads: featuredAds[] = [];
  public testimonial: testimonialList[] = [];
  public blog: blogList[] = [];
  public pricing: pricingList[] = [];
  public latestads: latestAdsList[] = [];
